...
// network.
static const PROGMEM u1_t NWKSKEY[16] = { 0x79, 0x7F, 0x8F, 0x8E, 0xCE, 0xB2, 0xC3, 0x54, 0x5A, 0xD7, 0xCB, 0xAF, 0x41, 0x36, 0xAD, 0x47 };

// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
static const u1_t PROGMEM APPSKEY[16] = { 0xEC, 0x23, 0x96, 0xCD, 0x40, 0x3A, 0x6E, 0x20, 0x7A, 0xBD, 0x3E, 0x28, 0x48, 0x2D, 0x83, 0xBB };

// LoRaWAN end-device address (DevAddr)
static const u4_t DEVADDR = 0x26021265;
...
void setup() {
  ...
  LMIC_setupChannel(5, 916800000, DR_RANGE_MAP(DR_SF12, DR_SF7),  BAND_CENTI);      // g-band
  for (int b = 0; b < 8; ++b) {
    LMIC_disableSubBand(b);
  }
  // Then enable the channel(s) you want to use
  LMIC_enableChannel(5); // 916.8 MHz
#endif
