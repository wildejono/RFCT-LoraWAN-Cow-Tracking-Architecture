...
# Wireless network
WIFI_SSID = "WildeHomeNetwork"
WIFI_PASS = "WildePulis101!" # No this is not our regular password. :)

# Adafruit IO (AIO) configuration
AIO_SERVER = "io.adafruit.com"
AIO_PORT = 1883
AIO_USER = "wildejono"
AIO_KEY = "aio_ezhr76IZlbgr97Pq7huh1dr7FzgU"
AIO_CLIENT_ID = ubinascii.hexlify(machine.unique_id())  # Can be anything
AIO_CONTROL_FEED = "wildejono/feeds/Lights"
AIO_RANDOMS_FEED = "wildejono/feeds/Randoms"
